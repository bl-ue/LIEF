...
**Main features**:
  ...
  * **API**: LIEF can be used in [C++](https://lief.re/doc/latest/doxygen/), Python, [Rust](https://lief-rs.s3.fr-par.scw.cloud/doc/latest/lief/index.html), C and [Node.js](https://github.com/Piebald-AI/node-lief) (3rd party)
